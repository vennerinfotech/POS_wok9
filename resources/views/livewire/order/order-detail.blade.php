                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                    ...
                                    @if (!in_array($order->status, ['paid', 'payment_due', 'canceled']) && user_can('Delete Order'))
                                        <td class="p-2 whitespace-nowrap text-right">
                                            <button class="rounded text-gray-800 dark:text-gray-400 border dark:border-gray-500 hover:bg-gray-200 dark:hover:bg-gray-900/20 p-2"
                    ...
                    <div class="h-auto pb-4 pt-3 select-none w-full">
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            <x-secondary-link wire:click="printOrder({{ $order->id }})" target="_blank"
                                class="min-h-[50px] rounded-xl bg-white hover:bg-gray-50 text-gray-700 border p-3 inline-flex flex-col items-center justify-center gap-1 transition-colors dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700">
