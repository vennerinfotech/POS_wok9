<div wire:poll.10s>
    <div class="p-4 bg-white block  dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            <div @class(['grid grid-cols-1 gap-2 w-full lg:w-auto', 'sm:grid-cols-3' => $kotSettings->default_status == 'pending', 'sm:grid-cols-2' => $kotSettings->default_status == 'cooking'])>
                @if ($kotSettings->default_status == 'pending')
                <div wire:click="$set('filterOrders', 'pending_confirmation')" @class(['whitespace-nowrap items-center font-medium
                    ...
                    dark:hover:text-white dark:text-neutral-400', ' border-2 border-skin-base dark:border-skin-base'=> ($filterOrders == 'pending_confirmation')])>
                ...
                <div wire:click="$set('filterOrders', 'in_kitchen')" @class(['whitespace-nowrap items-center font-medium
                    ...
                    dark:hover:text-white dark:text-neutral-400', ' border-2 border-skin-base dark:border-skin-base'=> ($filterOrders == 'in_kitchen')])>
                ...
                <div wire:click="$set('filterOrders', 'food_ready')" @class(['whitespace-nowrap items-center font-medium
                    cursor-pointer p-2 text-center rounded-md text-sm border hover:text-gray-900 bg-white
                    hover:bg-gray-200 w-full dark:bg-gray-800 dark:hover:bg-gray-700
                    dark:hover:text-white dark:text-neutral-400', ' border-2 border-skin-base dark:border-skin-base'=> ($filterOrders == 'food_ready')])>
